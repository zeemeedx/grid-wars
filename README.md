...
* Gameplay e Execução (Mobile/Web): Os oponentes não controlam o personagem em tempo real; em vez disso, eles devem analisar o mapa e pré-programar uma rota de fuga (incluindo comandos de movimentação e pausas estratégicas). Essa rota é analisada direto no frontend, que processa a simulação de colisões e retorna o resultado.
